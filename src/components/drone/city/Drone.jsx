...
export const Drone = React.forwardRef(({ moveDronePosY,
  ...
  useEffect(() => {
    ...
    const checkCollision = () => {
      ...
      // Ensure the drone and buildings are valid before proceeding
      if (!drone || !buildings || buildings.length === 0) return;
      ...
      try {
        ...
        const intersects = raycaster.intersectObjects(validBuildings);
